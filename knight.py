...
class Knight(Player):
    def __init__(self, player_num, base):
        ...
        self.base = base
        self.player = Actor("models/Knight/knight.bam",
    ...
    '''def special(self, num="1"):
        ...
        self.sword4.setPos(self.enemy.player.getPos())
        ...
        self.sword5.setPos(self.enemy.player.getPos())
    ...
    def special1_task(self, task):
        if self.in_special1:
            if task.time<3:
                ...
                if self.calc_abs_distance(self.sword5, self.enemy.player) <= 500 or self.calc_abs_distance(self.sword4, self.enemy.player) <= 500:
